...
type SQLNode interface {
	...
	genericWalkSubtree(visitor Visitor) error
	// walkSubtree calls visitor on all underlying nodes
	// of the subtree, but not the current one. Walking
	// must be interrupted if visitor returns an error.
...
// If visitor returns true, the underlying nodes
// are also visited. If it returns an error, walking
// is interrupted, and the error is returned.
func GenericWalk(visitor Visitor, nodes ...SQLNode) error {
	for _, node := range nodes {
		if node == nil {
			continue
		}

		kontinue, err := visitor.Visit(node)
		if err != nil {
			return err
		}
		if kontinue {
			err = node.genericWalkSubtree(visitor)
			if err != nil {
				return err
			}
		}
...
// can be used to visitor all nodes of a parse tree.
type Visit func(node SQLNode) (kontinue bool, err error)

// Walk calls visitor on every node.
// If visitor returns true, the underlying nodes
// are also visited. If it returns an error, walking
// is interrupted, and the error is returned.
...
func (node *Select) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *ParenSelect) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *Union) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *Stream) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *Insert) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *Update) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *Delete) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *Set) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *DBDDL) genericWalkSubtree(visitor Visitor) error {
	return nil
}
...
func (node *DDL) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *PartitionSpec) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	if err := GenericWalk(visitor, node.Name); err != nil {
		return err
	}
	for _, def := range node.Definitions {
		if err := GenericWalk(visitor, def); err != nil {
			return err
		}
	}
	return nil
...
func (node *PartitionDefinition) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (ts *TableSpec) genericWalkSubtree(visitor Visitor) error {
	if ts == nil {
		return nil
	}

	for _, n := range ts.Columns {
		if err := GenericWalk(visitor, n); err != nil {
			return err
		}
	}
...
func (col *ColumnDefinition) genericWalkSubtree(visitor Visitor) error {
	if col == nil {
		return nil
	}
	return GenericWalk(
...
func (ct *ColumnType) genericWalkSubtree(visitor Visitor) error {
	return nil
}
...
func (idx *IndexDefinition) genericWalkSubtree(visitor Visitor) error {
	if idx == nil {
		return nil
	}

	for _, n := range idx.Columns {
		if err := GenericWalk(visitor, n.Column); err != nil {
			return err
		}
	}
...
func (ii *IndexInfo) genericWalkSubtree(visitor Visitor) error {
	return GenericWalk(visitor, ii.Name)
}
...
func (node *VindexSpec) genericWalkSubtree(visitor Visitor) error {
	err := GenericWalk(visitor,
		node.Name,
	)
...
func (node VindexParam) genericWalkSubtree(visitor Visitor) error {
	return GenericWalk(visitor,
		node.Key,
	)
}
...
func (node *Show) genericWalkSubtree(visitor Visitor) error {
	return nil
}
...
func (node *ShowFilter) genericWalkSubtree(visitor Visitor) error {
	return nil
}
...
func (node *Use) genericWalkSubtree(visitor Visitor) error {
	return GenericWalk(visitor, node.DBName)
}
...
func (node *Begin) genericWalkSubtree(visitor Visitor) error {
	return nil
}
...
func (node *Commit) genericWalkSubtree(visitor Visitor) error {
	return nil
}
...
func (node *Rollback) genericWalkSubtree(visitor Visitor) error {
	return nil
}
...
func (node *OtherRead) genericWalkSubtree(visitor Visitor) error {
	return nil
}
...
func (node *OtherAdmin) genericWalkSubtree(visitor Visitor) error {
	return nil
}
...
func (node Comments) genericWalkSubtree(visitor Visitor) error {
	return nil
}
...
func (node SelectExprs) genericWalkSubtree(visitor Visitor) error {
	for _, n := range node {
		if err := GenericWalk(visitor, n); err != nil {
			return err
		}
...
func (node *StarExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *AliasedExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node Nextval) genericWalkSubtree(visitor Visitor) error {
	return GenericWalk(visitor, node.Expr)
}
...
func (node Columns) genericWalkSubtree(visitor Visitor) error {
	for _, n := range node {
		if err := GenericWalk(visitor, n); err != nil {
			return err
		}
...
func (node Partitions) genericWalkSubtree(visitor Visitor) error {
	for _, n := range node {
		if err := GenericWalk(visitor, n); err != nil {
			return err
		}
...
func (node TableExprs) genericWalkSubtree(visitor Visitor) error {
	for _, n := range node {
		if err := GenericWalk(visitor, n); err != nil {
			return err
		}
...
func (node *AliasedTableExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node TableNames) genericWalkSubtree(visitor Visitor) error {
	for _, n := range node {
		if err := GenericWalk(visitor, n); err != nil {
			return err
		}
...
func (node TableName) genericWalkSubtree(visitor Visitor) error {
	return GenericWalk(
		visitor,
		node.Name,
		node.Qualifier,
...
func (node *ParenTableExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node JoinCondition) genericWalkSubtree(visitor Visitor) error {
	return GenericWalk(
		visitor,
		node.On,
		node.Using,
...
func (node *JoinTableExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *IndexHints) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	for _, n := range node.Indexes {
...
func (node *Where) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node Exprs) genericWalkSubtree(visitor Visitor) error {
	for _, n := range node {
		if err := GenericWalk(visitor, n); err != nil {
			return err
		}
...
func (node *AndExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *OrExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *NotExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *ParenExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *ComparisonExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *RangeCond) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *IsExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *ExistsExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *SQLVal) genericWalkSubtree(visitor Visitor) error {
	return nil
}
...
func (node *NullVal) genericWalkSubtree(visitor Visitor) error {
	return nil
}
...
func (node BoolVal) genericWalkSubtree(visitor Visitor) error {
	return nil
}
...
func (node *ColName) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node ValTuple) genericWalkSubtree(visitor Visitor) error {
	return GenericWalk(visitor, Exprs(node))
}
...
func (node *Subquery) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node ListArg) genericWalkSubtree(visitor Visitor) error {
	return nil
}
...
func (node *BinaryExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *UnaryExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *IntervalExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *CollateExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *FuncExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *GroupConcatExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *ValuesFuncExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *SubstrExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *ConvertExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *ConvertUsingExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *ConvertType) genericWalkSubtree(visitor Visitor) error {
	return nil
}
...
func (node *MatchExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *CaseExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	if err := GenericWalk(visitor, node.Expr); err != nil {
		return err
	}
	...
	return GenericWalk(visitor, node.Else)
}
...
func (node *Default) genericWalkSubtree(visitor Visitor) error {
	return nil
}
...
func (node *When) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node GroupBy) genericWalkSubtree(visitor Visitor) error {
	for _, n := range node {
		if err := GenericWalk(visitor, n); err != nil {
			return err
		}
...
func (node OrderBy) genericWalkSubtree(visitor Visitor) error {
	for _, n := range node {
		if err := GenericWalk(visitor, n); err != nil {
			return err
		}
...
func (node *Order) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node *Limit) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node Values) genericWalkSubtree(visitor Visitor) error {
	for _, n := range node {
		if err := GenericWalk(visitor, n); err != nil {
			return err
		}
...
func (node UpdateExprs) genericWalkSubtree(visitor Visitor) error {
	for _, n := range node {
		if err := GenericWalk(visitor, n); err != nil {
			return err
		}
...
func (node *UpdateExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node SetExprs) genericWalkSubtree(visitor Visitor) error {
	for _, n := range node {
		if err := GenericWalk(visitor, n); err != nil {
			return err
		}
...
func (node *SetExpr) genericWalkSubtree(visitor Visitor) error {
	if node == nil {
		return nil
	}
	return GenericWalk(
...
func (node OnDup) genericWalkSubtree(visitor Visitor) error {
	return GenericWalk(visitor, UpdateExprs(node))
}
...
func (node ColIdent) genericWalkSubtree(visitor Visitor) error {
	return nil
}
...
func (node TableIdent) genericWalkSubtree(visitor Visitor) error {
	return nil
}
